...
namespace IAProiect
{
    class Node
    {
        ...
        private List<List<int>> _probabilities;

        public int Id { get { return _id; } }
        
        public Tuple<int, int> Position { get { return _position; } }

        public List<Node> Parents { get { return _parents; } set { _parents = value; } }

        public List<int> DomainOfValues { get { return _domainOfValues; } set { _domainOfValues = value; } }

        public List<List<int>> Probabilities { get { return _probabilities; } set { _probabilities = value; } }
